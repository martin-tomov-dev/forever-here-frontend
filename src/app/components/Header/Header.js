  ...
  return (
    <Root>
      <Box
        ...
        sx={{
          background: (theme) => `linear-gradient(0deg, ${theme.palette.primary.dark}99, ${theme.palette.primary.dark}99), url(${headerBackground}) no-repeat`,
      ...
      >
        { isMobile ? (
          <Box 
            ...
            sx={{ backgroundColor: (theme) => `${theme.palette.primary.dark}4D` }}
          >
            <NavbarToggleButton />
          </Box>
        ) : (
          ...
          >
            <ul>
              ...
              <a href="/forever-messages"><li>Forever Messages</li></a>
              <a href="/sign-in"><li className="btn-login"><LoginIcon className="text-18 md:text-20" /> Sign in</li></a>
              <a href="/sign-up"><li className="btn-register"><PersonAddAltOutlinedIcon className="text-18 md:text-20" /> Sign up</li></a>
            </ul>
          </Box>
        )}
        <div className="h-full flex flex-col">
          ...
          <div className="h-full flex flex-col justify-evenly md:mt-m36">
            { headerTitle && <div className="w-full">
              <Typography
            ...
            { headerDescription && <div className="w-full">
              <Typography
                component={motion.div}
                initial={{ opacity: 0, y: 0 }}
                animate={{ opacity: 1, y: 0, transition: { delay: 0.2 } }}
            ...
            {showHeaderButton && <div className="w-full text-center md:text-left px-16 md:pl-72">
              <motion.div
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0, transition: { delay: 0.2 } }}
              >
                <a href="/sign-up"><Button className="w-full md:w-auto" variant="contained" color="secondary">
                  <span className="mx-8 uppercase">Click here to create a memorial</span>
                </Button></a>
              </motion.div>
            </div>}
          </div>
